...
rhoFromP = interpolate.InterpolatedUnivariateSpline(p_EOS, rho_EOS, k=3)
pFromRho = interpolate.InterpolatedUnivariateSpline(rho_EOS, p_EOS, k=3)
...
#    print "M=",m_now
#    print "R=",rad
    target = open("SingleDataTrad.txt", 'w')
